...
<head>
    ...
    <script src="<?php echo base_url('public/bower_components/angular/angularJs-min.js');?>"></script>
    <script src="<?php echo base_url('public/bower_components/angular-route/angular-route.min.js');?>"></script>
    <script src="<?php echo base_url('public/bower_components/angular-boostrap/ui-boostrap.min.js');?>"</script>
...
<!-- ACA TERMINA EL HEADER -->
    ...
    <script src="<?php echo base_url('public/node_modules/angular-morris-chart/src/angular-morris-chart.min.js');?>"></script>

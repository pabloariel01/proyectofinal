...
<head>
    ...
    <script src="<?php echo base_url('public/node_modules/angular-ui-grid/ui-grid.min.js');?>"></script>
...
<div class="row-fluid">
    <div class="span3" id="sidebar">
        ...
        <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">        
            <!--<li>
                <a href="#" ng-click="metodo_vista(1)">
                    <i class="icon-chevron-right"></i> 
                    Relación Fundamental
                </a>
            </li>
            <li>
                <a href="#" ng-click="metodo_vista(2)">
                    <i class="icon-chevron-right"></i> 
                    Metodo Aditivo
                </a>
            </li>
            <li>
                <a href="#" ng-click="metodo_vista(3)">
                    <i class="icon-chevron-right"></i> 
                    Metodo Multiplicativo 
                </a>
            </li>
            <li>
                <a href="#" ng-click="metodo_vista(4)">
                    <i class="icon-chevron-right"></i> 
                    Metodo Mixto
                </a>
            </li>
